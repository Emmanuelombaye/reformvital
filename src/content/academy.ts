...
export const academyArticles: AcademyArticle[] = [
  ...
  {
    slug: "daily-habits-that-stick",
    title: "Daily Habits That Complement Your Protocol",
    category: "Daily Habits",
    categorySlug: "insights",
    summary: "Small routines—protein, sleep, movement, and tracking—that make treatment results more sustainable.",
    readTime: "5 min",
    published: "August 2026",
    image: "/images/topics/daily-habits.png",
    what: "Daily habits are the lifestyle layer around your program: consistent meals, sleep, hydration, and light movement.",
    why: "Medication works best when everyday routines support energy, protein intake, and recovery.",
    whatToDo: ["Keep a simple morning and evening routine you can repeat.", "Pair protein with every meal, even when appetite is low.", "Track sleep and steps so patterns are easy to see."],
    whenPhysician: "Always escalate emergencies to 911 or local ER—lifestyle guidance is not for acute crises.",
    tips: ["Habit stacking beats overhauls.", "A short walk after meals is often more sustainable than intense workouts."],
    relatedSlugs: ["nutrition-weight-management", "understanding-labs"],
  },
];
...
export const categoryMeta: CategoryMeta[] = [
  ...
  },
  {
    ...
    guideSlug: "executive-health-guide",
    faqs: [
      { q: "Which daily habits matter most during treatment?", a: "Protein at meals, consistent sleep, hydration, and light daily movement—especially walking after meals." },
      { q: "Do I need a complicated routine?", a: "No. A short, repeatable morning and evening routine is more effective than an extreme overhaul." },
    ],
    tips: ["Stack new habits onto something you already do.", "Track sleep and steps so small wins stay visible."],
  },
];
