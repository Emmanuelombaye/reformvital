export const brandConfig = {
  ...
  healthAcademy: {
    ...
    categories: [
      ...
      { slug: "hormones", label: "Hormone Optimization", href: "/resources/category/hormones", image: "/images/why-wellness.png" },
      ...
      { slug: "sleep", label: "Sleep", href: "/resources/category/sleep", image: "/images/start-wellness.png" },
      ...
      { slug: "mental", label: "Mental Wellness", href: "/resources/category/mental", image: "/images/start-wellness.png" },
  ...
  memberExperience: {
    ...
    inclusions: [
      ...
      { label: "Prescription Management", desc: "Refills, dosage titration, and pharmacy coordination handled for you.", image: "/images/member-nutrition.png" },
